...
public class MainActivity extends AppCompatActivity {
    ...
    // 支持两个来源的广播 action
    private static final String ACTION_QQ  = "com.haifeng.ACTION_QQ_CONTROLLER";
    private static final String ACTION_NCM = "com.haifeng.ACTION_NCM_CONTROLLER";
...
// 启动时如果偏好是 true 且当前是 QQ 模式，按原逻辑主动开启
        ...
        if (switchNcm != null) {
            ...
            switchNcm.setOnCheckedChangeListener((btn, isChecked) -> {
                ...
                LocalBroadcastManager.getInstance(this).sendBroadcast(
                        new Intent(isChecked ? "com.haifeng.REQUEST_NCM_TOKEN"
                                : "com.haifeng.REQUEST_QQ_TOKEN"));
        ...
        filter.addAction(ACTION_QQ);   // "com.haifeng.ACTION_QQ_CONTROLLER"
        filter.addAction(ACTION_NCM);  // "com.haifeng.ACTION_NCM_CONTROLLER"
